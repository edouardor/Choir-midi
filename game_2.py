...
my_midi_file = '/Users/eduardoratier/Downloads/CAT00514 BAJO.mid'
...
while running:
    ...
    pygame.draw.line(surface1, (238, 240, 223, 255), (dt+10, 0), (dt+11, screenHeight), 10)
    pygame.draw.line(surface1, (255, 255, 255, 255), (dt+5, 0), (dt+7, screenHeight), 10)
    ...
    if not q.empty():
        ...
        sing_sprite = sing_display(x+5,y,3)
